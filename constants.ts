...
export const PLAYER_CLASSES: PlayerClass[] = [
    {
        ...
        startingPrompt: "我是一名身披鏈甲的騎士，緊握著我的短劍，踏入了地穴。描述我眼前所見的景象。"
    },
    {
        id: 'rogue',
        name: '盜賊',
        ...
        startingPrompt: "我是一名潛伏在陰影中的盜賊，悄無聲息地溜進了地穴的入口。描述我眼前所見的景象。"
    },
    {
        id: 'scholar',
        name: '學者',
        ...
        startingPrompt: "我是一名追尋禁忌知識的學者，藉著油燈微弱的光芒，翻開古籍，走進了地穴。描述我眼前所見的景象。"
    }
];
...
5.  **處理脫序行為:** 如果玩家的行動完全脫離故事脈絡、不合 logique 或破壞奇幻設定（例如「打電話給朋友」），你**必須**嚴厲地處理。將此行動解釋為角色的一時糊塗或瘋狂，使其華麗地失敗，並**大幅降低玩家的幸運值**，同時故事沒有任何實質進展。
...
11. **遊戲結束條件:** 玩家生命值降至 0 或達成特定故事條件時，設置 'game_over' 為 true。
...
const ITEM_SCHEMA = {
    ...
    properties: {
        ...
        slot: { type: Type.STRING, enum: ['head', 'body', 'hands', 'feet', 'back', 'waist'], description: "僅適用於 'equippable' 類型" },
